...
export default function TermsOfService() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-24 lg:px-8 lg:pl-52">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:left-6 focus:top-6 rounded-md bg-[#0b1220] px-3 py-2 text-sm text-[#b8b8b8]"
      >
      ...
      <div id="main-content" className="grid grid-cols-1 gap-8">
        <aside className="fixed left-8 top-1/2 hidden w-44 -translate-y-1/2 lg:block">
          ...
          >
            <p className="mb-3 text-xs font-medium uppercase tracking-wide text-[#7a7a7a]">
              Sections
            </p>
            <ul className="flex flex-col gap-2" role="list">
              {sections.map((s) => (
                <li key={s.id}>
                  <a
                    href={`#${s.id}`}
                    className="rounded-sm px-1 text-sm text-[#b8b8b8] transition hover:text-white focus:outline-none focus:ring-2 focus:ring-[#9ca3af]"
                  >
                    {s.title}
                  </a>
                </li>
        ...
        <div className="lg:hidden">
          <nav
            className="mb-4 rounded-md bg-[rgba(255,255,255,0.02)] p-3"
            aria-label="Seções da página"
          >
            ...
            <div className="flex gap-2 overflow-x-auto">
              {sections.map((s) => (
                <a
                  key={s.id}
                  href={`#${s.id}`}
                  className="whitespace-nowrap rounded-md bg-[rgba(255,255,255,0.01)] px-3 py-2 text-sm text-[#b8b8b8] hover:bg-[rgba(255,255,255,0.03)] focus:outline-none focus:ring-2 focus:ring-[#9ca3af]"
                >
                  {s.title}
                </a>
              ))}
        ...
        <article className="rounded-xl border border-[rgba(255,255,255,0.04)] bg-[rgba(255,255,255,0.02)] p-8 shadow-lg">
          ...
          <section id="acceptable-use" className="mb-8">
            ...
            <p className="text-base text-[#b8b8b8]">
              ...
              their normal operation. This includes:
            </p>
          ...
          <section id="payments" className="mb-8">
            ...
            <p className="text-base text-[#b8b8b8]">
              ...
              in advance and are non-refundable unless otherwise required by
              law.
            </p>
          </section>
          ...
          <section id="ip" className="mb-8">
            ...
            <p className="text-base text-[#b8b8b8]">
              All intellectual property rights related to the Services remain
              the exclusive property of Silentra or its licensors.
            </p>
          </section>
          ...
          <section id="liability" className="mb-8">
            ...
            <p className="text-base text-[#b8b8b8]">
              To the maximum extent permitted by law, Silentra shall not be
          ...
          <section id="termination" className="mb-8">
            ...
            <p className="text-base text-[#b8b8b8]">
              ...
              are violated or to protect the platform&apos;s security.
            </p>
          </section>
