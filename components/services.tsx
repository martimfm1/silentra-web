...
export function Services() {
  ...
  return (
    <section
      ...
      aria-label={locale === "pt" ? "Serviços" : "Services"}
    >
      <motion.div
        style={{ y: glowY }}
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-1/2 h-[700px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.025)_0%,transparent_70%)] blur-3xl"
      />
      <motion.div
        style={{ y: gridY }}
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-20 h-[420px] opacity-40 bg-grid"
      />
      <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                  <div className="flex items-center justify-between">
                    <motion.div
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/[0.08] bg-white/[0.035] transition group-hover:border-white/[0.16] group-hover:bg-white/[0.07]"
                    >
                      <Icon
                        size={18}
                        className="text-[#b8b8b8] transition-colors group-hover:text-white"
                        aria-hidden="true"
                      />
                    </motion.div>
                    <ArrowUpRight
                      size={16}
                      className="text-[#555] transition-all group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-white"
                      aria-hidden="true"
                    />
                  </div>
                  ...
                  <div
                    aria-hidden="true"
                    className="pointer-events-none absolute inset-x-6 top-0 h-px origin-left scale-x-0 bg-white/30 transition-transform duration-500 group-hover:scale-x-100"
                  />
                </motion.a>
              );
            })}
        ...
        <motion.p
          ...
          className="mt-5 text-center text-[11px] text-[#555]"
        >
          {t.note}{" "}
          <a
            href="#contact"
            className="text-[#b8b8b8] underline decoration-white/20 underline-offset-4 transition hover:text-white"
          >
            {t.link}
          </a>
        </motion.p>
