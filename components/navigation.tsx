        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex min-h-16 items-center justify-between gap-4">
            ...
            >
              ...
              <span className="text-sm font-semibold tracking-wide text-white transition-colors group-hover:text-[#b8b8b8]">
                Silentra
              </span>
            </a>
            ...
            <nav className="hidden items-center gap-1 md:flex" aria-label="Main navigation">
              {navLinks.map((link) => (
                <a
                  ...
                  className="rounded-md px-3 py-2 text-sm text-[#7a7a7a] transition-colors hover:bg-white/[0.04] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
                >
                  {link.label}
                </a>
              ))}
            ...
            <div className="hidden items-center gap-2 md:flex">
              <a
                ...
                aria-label="Instagram @silentra.dev"
                title="Instagram @silentra.dev"
              >
            ...
            <button
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-white/10 text-[#b8b8b8] transition hover:border-white/20 hover:bg-white/[0.05] hover:text-white md:hidden"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 top-16 z-40 border-b border-white/[0.07] bg-[rgba(5,5,5,0.98)] backdrop-blur-xl md:hidden"
          >
            <nav className="mx-auto flex max-w-7xl flex-col gap-1 px-4 py-4 sm:px-6" aria-label="Mobile navigation">
              {navLinks.map((link) => (
                <a
                  ...
                  className="rounded-xl px-4 py-3.5 text-base text-[#b8b8b8] transition hover:bg-white/[0.05] hover:text-white"
                >
                  {link.label}
                </a>
              ))}
              <div className="mt-3 grid grid-cols-[1fr_auto] gap-2 border-t border-white/[0.06] pt-4">
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-xl bg-white px-4 py-3 text-sm font-semibold text-black transition hover:bg-white/90"
                >
                  Let&apos;s talk
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex h-12 w-12 items-center justify-center rounded-xl border border-white/10 text-[#b8b8b8] transition hover:bg-white/[0.05] hover:text-white"
                  aria-label="Instagram @silentra.dev"
                >
